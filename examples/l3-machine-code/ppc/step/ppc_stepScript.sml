(* ------------------------------------------------------------------------
   Definitions and theorems used by PowerPC step evaluator (ppc_stepLib)
   ------------------------------------------------------------------------ *)
...
open state_transformerTheory alignmentTheory ppcTheory

val _ = new_theory "ppc_step"
...
Theorem NextStatePPC:
  ...
  (NextStatePPC s = SOME s1)
Proof
  rw [] \\ gvs [NextStatePPC_def, Next_def, Decode_def]
QED
...
val Align = Q.store_thm("Align",
   `(!w. Align (w, 1) = align 0 w) /\
    ...
    simp [ppcTheory.Align_def, alignmentTheory.align_w2n]
    )
...
val Aligned = Q.store_thm("Aligned",
   `(!w. Aligned (w, 1) = aligned 0 w) /\
    ...
    simp [ppcTheory.Aligned_def, Align, alignmentTheory.aligned_def,
...
Theorem IMP_Fetch[local]:
  (s.MEM s.PC        = v2w [b31; b30; b29; b28; b27; b26; b25; b24]) ∧
  (s.MEM (s.PC + 1w) = v2w [b23; b22; b21; b20; b19; b18; b17; b16]) ∧
  (s.MEM (s.PC + 2w) = v2w [b15; b14; b13; b12; b11; b10; b9;  b8 ]) ∧
  (s.MEM (s.PC + 3w) = v2w [b7;  b6;  b5;  b4;  b3;  b2;  b1;  b0 ]) ∧
  aligned 2 s.PC ⇒
  (Fetch s = (Inst (v2w [b31; b30; b29; b28; b27; b26; b25; b24;
                         b23; b22; b21; b20; b19; b18; b17; b16;
                         b15; b14; b13; b12; b11; b10; b9 ; b8 ;
                         b7;  b6;  b5;  b4;  b3;  b2;  b1;  b0 ]),s))
Proof
  fs [Fetch_def,MemA_def,Aligned,mem_def,mem1_def,bitstringTheory.w2v_v2w]
  \\ fs [bitstringTheory.field_def,bitstringTheory.shiftr_def]
QED
