(* arm8Script.sml - generated by L3 - Tue Apr 11 20:51:12 2023 *)
...
val dfn'FloatingPointAddSub_def = Def
  ("dfn'FloatingPointAddSub",
   TP[Var("op",F1),Var("ftype",FTy 2),Var("d",FTy 5),Var("n",FTy 5),
      Var("m",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
...
val dfn'FloatingPointMov_def = Def
  ("dfn'FloatingPointMov",
   TP[Var("sf",F1),Var("ftype",FTy 2),Var("opcode0",F1),Var("d",FTy 5),
      Var("n",FTy 5)],
   Close
     (qVar"state",
...
val dfn'FloatingPointMul_def = Def
  ("dfn'FloatingPointMul",
   TP[Var("ftype",FTy 2),Var("d",FTy 5),Var("n",FTy 5),Var("m",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
         [(LW(1,2),
