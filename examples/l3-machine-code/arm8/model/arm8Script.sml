(* arm8Script.sml - generated by L3 - Sun May 07 13:04:44 2023 *)
         ...
         [(Const("Reserved",CTy"instruction"),
          ...
          (Call
             ("Address",CTy"instruction",
              Var("v88",PTy(bTy,PTy(F64,FTy 5)))),
           Apply
             (Call
                ("dfn'Address",ATy(qTy,qTy),
                 Var("v88",PTy(bTy,PTy(F64,FTy 5)))),qVar"state")),
          (Call("ClearExclusive",CTy"instruction",Var("v89",F4)),
           Apply
             (Call("dfn'ClearExclusive",ATy(qTy,qTy),Var("v89",F4)),
              qVar"state")),
          (Call("Hint",CTy"instruction",Var("v90",CTy"SystemHintOp")),
           Apply
             (Call("dfn'Hint",ATy(qTy,qTy),Var("v90",CTy"SystemHintOp")),
              qVar"state")),
          (Call
             ("MemoryBarrier",CTy"instruction",
              Var("v91",PTy(CTy"MemBarrierOp",F4))),
           Apply
             (Call
                ("dfn'MemoryBarrier",ATy(qTy,qTy),
                 Var("v91",PTy(CTy"MemBarrierOp",F4))),qVar"state")),
              ...
              [(Call
               ...
               (Call
                  ("FloatingPointMul",CTy"Data",
                   Var("v41",PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("MultiplyHigh",CTy"Data",
                   Var("v52",PTy(bTy,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@32",CTy"Data",
                   Var("v53",PTy(F32,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@64",CTy"Data",
                   Var("v54",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'Reverse",ATy(qTy,qTy),
                      Var("v54",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                      ...
                      Var("v56",
                          PTy(F64,
                              PTy(CTy"ShiftType",
                                  PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                   qVar"state"))])),
          (Call("Debug",CTy"instruction",Var("v57",CTy"Debug")),
           CS(Var("v57",CTy"Debug"),
              [(Const("DebugRestore",CTy"Debug"),
                Apply(Const("dfn'DebugRestore",ATy(qTy,qTy)),qVar"state")),
               (Call("Breakpoint",CTy"Debug",Var("v58",F16)),
                Apply
                  (Call("dfn'Breakpoint",ATy(qTy,qTy),Var("v58",F16)),
                   qVar"state")),
               (Call("DebugSwitch",CTy"Debug",Var("v59",FTy 2)),
                Apply
                  (Call("dfn'DebugSwitch",ATy(qTy,qTy),Var("v59",FTy 2)),
                   qVar"state")),
               (Call("Halt",CTy"Debug",Var("v60",F16)),
                Apply
                  (Call("dfn'Halt",ATy(qTy,qTy),Var("v60",F16)),
                   qVar"state"))])),
          (Call("LoadStore",CTy"instruction",Var("v61",CTy"LoadStore")),
           CS(Var("v61",CTy"LoadStore"),
              [(Call
               ...
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state"))])),
          (Call("System",CTy"instruction",Var("v81",CTy"System")),
           CS(Var("v81",CTy"System"),
              [(Const("ExceptionReturn",CTy"System"),
                Apply
                  (Const("dfn'ExceptionReturn",ATy(qTy,qTy)),qVar"state")),
               (Call("HypervisorCall",CTy"System",Var("v82",F16)),
                Apply
                  (Call("dfn'HypervisorCall",ATy(qTy,qTy),Var("v82",F16)),
                   qVar"state")),
               (Call
                  ("MoveImmediateProcState",CTy"System",
                   Var("v83",PTy(CTy"PSTATEField",F4))),
                Apply
                  (Call
                     ("dfn'MoveImmediateProcState",ATy(qTy,qTy),
                      Var("v83",PTy(CTy"PSTATEField",F4))),qVar"state")),
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state")),
               (Call("SecureMonitorCall",CTy"System",Var("v85",F16)),
                Apply
                  (Call
                     ("dfn'SecureMonitorCall",ATy(qTy,qTy),Var("v85",F16)),
                   qVar"state")),
               (Call("SupervisorCall",CTy"System",Var("v86",F16)),
                Apply
                  (Call("dfn'SupervisorCall",ATy(qTy,qTy),Var("v86",F16)),
                   qVar"state")),
               (Call
  ...
  ("e_data",Var("i",CTy"Data"),
   CS(Var("i",CTy"Data"),
      [(Call
       ...
       (Call
          ("FloatingPointAddSub",CTy"Data",
           TP[Var("op",F1),Var("ftype",FTy 2),Var("rd",FTy 5),
              Var("rn",FTy 5),Var("rm",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
       ...
       (Call
          ("FloatingPointMul",CTy"Data",
           TP[Var("ftype",FTy 2),Var("rd",FTy 5),Var("rn",FTy 5),
              Var("rm",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
