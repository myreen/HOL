(* arm8Script.sml - generated by L3 - Mon May 08 12:18:53 2023 *)
...
val _ = Record
  ("FPCR",
   [("AH",bTy),("AHP",bTy),("DN",bTy),("DZE",bTy),("EBF",bTy),("FIZ",bTy),
    ("FZ",bTy),("FZ16",bTy),("IDE",bTy),("IOE",bTy),("IXE",bTy),
    ("Len",FTy 3),("NEP",bTy),("OFE",bTy),("RES0",FTy 11),("RMode",FTy 2),
    ("Stride",FTy 2),("UFE",bTy)])
;
val _ = Record
  ("FPSR",
   [("C",bTy),("DZC",bTy),("IDC",bTy),("IOC",bTy),("IXC",bTy),("N",bTy),
    ("OFC",bTy),("QC",bTy),("RES0",FTy 21),("UFC",bTy),("V",bTy),("Z",bTy)])
;
val _ = Construct
  [("LogicalOp",
  ...
  [("LoadStore",
    [("LoadLiteral@32",[PTy(F32,PTy(CTy"MemOp",PTy(bTy,PTy(F64,FTy 5))))]),
     ...
     ("LoadStoreRegisterFloatingPoint",
      [PTy(FTy 2,PTy(FTy 2,PTy(FTy 12,PTy(FTy 5,FTy 5))))])])]
;
val _ = Construct
  [("Branch",
...
val _ = Construct
  [("Data",
    [("AddSubCarry@32",
     ...
     ("FloatingPointAddSub",
      [PTy(F1,PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))]),
     ("FloatingPointCompare",[PTy(FTy 2,PTy(FTy 2,PTy(FTy 5,FTy 5)))]),
     ("FloatingPointDiv",[PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5)))]),
     ("FloatingPointMov",[PTy(F1,PTy(FTy 2,PTy(F1,PTy(FTy 5,FTy 5))))]),
     ("FloatingPointMovImm",[PTy(FTy 2,PTy(F8,FTy 5))]),
     ("FloatingPointMul",[PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5)))]),
     ("FloatingPointMulAdd",
      [PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,PTy(FTy 5,FTy 5))))]),
     ("LogicalImmediate@32",
...
val _ = Construct
  [("exception",
    [("ALIGNMENT_FAULT",[]),("ASSERT",[sTy]),("NoException",[]),
     ("UNDEFINED_FAULT",[sTy]),("UNSUPPORTED",[sTy])])]
;
val _ = Record
  ("arm8_state",
   [("FPCR",CTy"FPCR"),("FPREG",ATy(FTy 5,F64)),("FPSR",CTy"FPSR"),
                                                    ...
                                                    Call
                                                      ("Ones",vTy,
                                                       Bop(Add,
                                                           ...
                                                           LN 1))]))]))))))))))
;
val rec'FPCR_def = Def
  ("rec'FPCR",Var("x",F32),
   Rec(CTy"FPCR",
       [Bop(Bit,Var("x",F32),LN 1),Bop(Bit,Var("x",F32),LN 26),
        Bop(Bit,Var("x",F32),LN 25),Bop(Bit,Var("x",F32),LN 9),
        Bop(Bit,Var("x",F32),LN 13),Bop(Bit,Var("x",F32),LN 0),
        Bop(Bit,Var("x",F32),LN 24),Bop(Bit,Var("x",F32),LN 19),
        Bop(Bit,Var("x",F32),LN 15),Bop(Bit,Var("x",F32),LN 8),
        Bop(Bit,Var("x",F32),LN 12),EX(Var("x",F32),LN 18,LN 16,FTy 3),
        Bop(Bit,Var("x",F32),LN 2),Bop(Bit,Var("x",F32),LN 10),
        CC[EX(Var("x",F32),LN 31,LN 27,FTy 5),
           EX(Var("x",F32),LN 14,LN 14,F1),
           EX(Var("x",F32),LN 7,LN 3,FTy 5)],
        EX(Var("x",F32),LN 23,LN 22,FTy 2),
        EX(Var("x",F32),LN 21,LN 20,FTy 2),Bop(Bit,Var("x",F32),LN 11)]))
;
val reg'FPCR_def = Def
  ("reg'FPCR",Var("x",CTy"FPCR"),
   CS(Var("x",CTy"FPCR"),
      [(Rec(CTy"FPCR",
            [bVar"AH",bVar"AHP",bVar"DN",bVar"DZE",bVar"EBF",bVar"FIZ",
             bVar"FZ",bVar"FZ16",bVar"IDE",bVar"IOE",bVar"IXE",
             Var("Len",FTy 3),bVar"NEP",bVar"OFE",Var("RES0",FTy 11),
             Var("RMode",FTy 2),Var("Stride",FTy 2),bVar"UFE"]),
        CC[EX(Var("RES0",FTy 11),LN 10,LN 6,FTy 5),Mop(Cast F1,bVar"AHP"),
           Mop(Cast F1,bVar"DN"),Mop(Cast F1,bVar"FZ"),Var("RMode",FTy 2),
           Var("Stride",FTy 2),Mop(Cast F1,bVar"FZ16"),Var("Len",FTy 3),
           Mop(Cast F1,bVar"IDE"),EX(Var("RES0",FTy 11),LN 5,LN 5,F1),
           Mop(Cast F1,bVar"EBF"),Mop(Cast F1,bVar"IXE"),
           Mop(Cast F1,bVar"UFE"),Mop(Cast F1,bVar"OFE"),
           Mop(Cast F1,bVar"DZE"),Mop(Cast F1,bVar"IOE"),
           EX(Var("RES0",FTy 11),LN 4,LN 0,FTy 5),Mop(Cast F1,bVar"NEP"),
           Mop(Cast F1,bVar"AH"),Mop(Cast F1,bVar"FIZ")])]))
;
val write'rec'FPCR_def = Def
  ("write'rec'FPCR",TP[AVar F32,Var("x",CTy"FPCR")],
   Call("reg'FPCR",F32,Var("x",CTy"FPCR")))
;
val write'reg'FPCR_def = Def
  ("write'reg'FPCR",TP[AVar(CTy"FPCR"),Var("x",F32)],
   Call("rec'FPCR",CTy"FPCR",Var("x",F32)))
;
val rec'FPSR_def = Def
  ("rec'FPSR",Var("x",F32),
   Rec(CTy"FPSR",
       [Bop(Bit,Var("x",F32),LN 29),Bop(Bit,Var("x",F32),LN 1),
        Bop(Bit,Var("x",F32),LN 7),Bop(Bit,Var("x",F32),LN 0),
        Bop(Bit,Var("x",F32),LN 4),Bop(Bit,Var("x",F32),LN 31),
        Bop(Bit,Var("x",F32),LN 2),Bop(Bit,Var("x",F32),LN 27),
        CC[EX(Var("x",F32),LN 26,LN 8,FTy 19),
           EX(Var("x",F32),LN 6,LN 5,FTy 2)],Bop(Bit,Var("x",F32),LN 3),
        Bop(Bit,Var("x",F32),LN 28),Bop(Bit,Var("x",F32),LN 30)]))
;
val reg'FPSR_def = Def
  ("reg'FPSR",Var("x",CTy"FPSR"),
   CS(Var("x",CTy"FPSR"),
      [(Rec(CTy"FPSR",
            [bVar"C",bVar"DZC",bVar"IDC",bVar"IOC",bVar"IXC",bVar"N",
             bVar"OFC",bVar"QC",Var("RES0",FTy 21),bVar"UFC",bVar"V",
             bVar"Z"]),
        CC[Mop(Cast F1,bVar"N"),Mop(Cast F1,bVar"Z"),Mop(Cast F1,bVar"C"),
           Mop(Cast F1,bVar"V"),Mop(Cast F1,bVar"QC"),
           EX(Var("RES0",FTy 21),LN 20,LN 2,FTy 19),
           Mop(Cast F1,bVar"IDC"),EX(Var("RES0",FTy 21),LN 1,LN 0,FTy 2),
           Mop(Cast F1,bVar"IXC"),Mop(Cast F1,bVar"UFC"),
           Mop(Cast F1,bVar"OFC"),Mop(Cast F1,bVar"DZC"),
           Mop(Cast F1,bVar"IOC")])]))
;
val write'rec'FPSR_def = Def
  ("write'rec'FPSR",TP[AVar F32,Var("x",CTy"FPSR")],
   Call("reg'FPSR",F32,Var("x",CTy"FPSR")))
;
val write'reg'FPSR_def = Def
  ("write'reg'FPSR",TP[AVar(CTy"FPSR"),Var("x",F32)],
   Call("rec'FPSR",CTy"FPSR",Var("x",F32)))
;
val D_def = Def
  ("D",Var("n",FTy 5),
   Close
     (qVar"state",
      Apply(Dest("FPREG",ATy(FTy 5,F64),qVar"state"),Var("n",FTy 5))))
;
val write'D_def = Def
  ("write'D",TP[Var("value",F64),Var("n",FTy 5)],
   Close
     (qVar"state",
      Rupd
        ("FPREG",
         TP[qVar"state",
            Fupd
              (Dest("FPREG",ATy(FTy 5,F64),qVar"state"),Var("n",FTy 5),
               Var("value",F64))])))
;
val RoundingMode_def = Def
  ("RoundingMode",qVar"state",
   CS(Dest("RMode",FTy 2,Dest("FPCR",CTy"FPCR",qVar"state")),
      [(LW(0,2),binary_ieeeSyntax.roundTiesToEven_tm),
       (LW(1,2),binary_ieeeSyntax.roundTowardPositive_tm),
       (LW(2,2),binary_ieeeSyntax.roundTowardNegative_tm),
       (LW(3,2),binary_ieeeSyntax.roundTowardZero_tm)]))
;
val FPAdd64_def = Def
  ("FPAdd64",TP[Var("op1",F64),Var("op2",F64)],
   Close
     (qVar"state",
      Mop(FPAdd 64,
          TP[Apply(Const("RoundingMode",ATy(qTy,rTy)),qVar"state"),
             Var("op1",F64),Var("op2",F64)])))
;
val FPSub64_def = Def
  ("FPSub64",TP[Var("op1",F64),Var("op2",F64)],
   Close
     (qVar"state",
      Mop(FPSub 64,
          TP[Apply(Const("RoundingMode",ATy(qTy,rTy)),qVar"state"),
...
;
val FPMul64_def = Def
  ("FPMul64",TP[Var("op1",F64),Var("op2",F64)],
   Close
     (qVar"state",
      Mop(FPMul 64,
          TP[Apply(Const("RoundingMode",ATy(qTy,rTy)),qVar"state"),
...
;
val FPDiv64_def = Def
  ("FPDiv64",TP[Var("op1",F64),Var("op2",F64)],
   Close
     (qVar"state",
      Mop(FPDiv 64,
          TP[Apply(Const("RoundingMode",ATy(qTy,rTy)),qVar"state"),
             Var("op1",F64),Var("op2",F64)])))
;
val FPCompare64_def = Def
  ("FPCompare64",TP[Var("op1",F64),Var("op2",F64)],
   ITB([(Bop(Or,Mop(FPIsNan 64,Var("op1",F64)),
             Mop(FPIsNan 64,Var("op2",F64))),TP[LF,LF,LT,LT]),
        (Mop(FPEq 64,TP[Var("op1",F64),Var("op2",F64)]),TP[LF,LT,LT,LF]),
        (Mop(FPLt 64,TP[Var("op1",F64),Var("op2",F64)]),TP[LT,LF,LF,LF])],
       TP[LF,LF,LT,LF]))
;
val FPZero64_def = Def
  ("FPZero64",Var("sign",F1),CC[Var("sign",F1),LW(0,63)])
;
val FPExpandImm8_def = Def
  ("FPExpandImm8",Var("imm8",F8),
   CC[EX(Var("imm8",F8),LN 7,LN 7,F1),
      Mop(BNot,EX(Var("imm8",F8),LN 6,LN 6,F1)),
      REP(EX(Var("imm8",F8),LN 6,LN 6,F1),LN 8,F8),
      EX(Var("imm8",F8),LN 5,LN 0,FTy 6),REP(LW(0,1),LN 48,FTy 48)])
;
val dfn'FloatingPointAddSub_def = Def
  ("dfn'FloatingPointAddSub",
   TP[Var("op",F1),Var("ftype",FTy 2),Var("m",FTy 5),Var("n",FTy 5),
      Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
                     ...
                     ("write'D",ATy(qTy,qTy),
                      TP[Apply
                           (Call
                              ("FPAdd64",ATy(qTy,F64),
                               TP[Apply
                                    (Call("D",ATy(qTy,F64),Var("n",FTy 5)),
                                     qVar"state"),
                                  Apply
                                    (Call("D",ATy(qTy,F64),Var("m",FTy 5)),
           ...
           Mop(Snd,
               Apply
                 (Call
                    ("raise'exception",ATy(qTy,PTy(uTy,qTy)),
                     Call
                       ("UNSUPPORTED",CTy"exception",
                        LS"Floating-point op not double-precision")),
                  qVar"state")))])))
;
val dfn'FloatingPointMul_def = Def
  ("dfn'FloatingPointMul",
   TP[Var("ftype",FTy 2),Var("m",FTy 5),Var("n",FTy 5),Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
         [(LW(1,2),
                      ...
                      (Call
                         ("FPMul64",ATy(qTy,F64),
                          TP[Apply
                             ...
                             Apply
                               (Call("D",ATy(qTy,F64),Var("m",FTy 5)),
                                qVar"state")]),qVar"state"),Var("d",FTy 5)]),
              qVar"state")),
          (AVar(FTy 2),
           Mop(Snd,
               Apply
                 (Call
                  ...
                  qVar"state")))])))
;
val dfn'FloatingPointMulAdd_def = Def
  ("dfn'FloatingPointMulAdd",
   TP[Var("ftype",FTy 2),Var("m",FTy 5),Var("a",FTy 5),Var("n",FTy 5),
      Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
                ...
                ("write'D",ATy(qTy,qTy),
                 TP[Apply
                      (Call
                         ("FPAdd64",ATy(qTy,F64),
                          TP[Apply
                               (Call("D",ATy(qTy,F64),Var("a",FTy 5)),
                                qVar"state"),
                             Apply
                               (Call
                                  ("FPMul64",ATy(qTy,F64),
           ...
           Mop(Snd,
               Apply
                 (Call
                  ...
                  qVar"state")))])))
;
val dfn'FloatingPointDiv_def = Def
  ("dfn'FloatingPointDiv",
   TP[Var("ftype",FTy 2),Var("m",FTy 5),Var("n",FTy 5),Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
           ...
           Mop(Snd,
               Apply
                 (Call
                  ...
                  qVar"state")))])))
;
val dfn'FloatingPointCompare_def = Def
  ("dfn'FloatingPointCompare",
   TP[Var("ftype",FTy 2),Var("opc",FTy 2),Var("m",FTy 5),Var("n",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
         [(LW(1,2),
           CS(EX(Var("opc",FTy 2),LN 0,LN 0,F1),
              [(LW(0,1),
                Apply
                  (Call
                     ("SetTheFlags",ATy(qTy,qTy),
                      TP[LT,
                         Call
                           ("FPCompare64",PTy(bTy,PTy(bTy,PTy(bTy,bTy))),
                            TP[Apply
                                 (Call("D",ATy(qTy,F64),Var("n",FTy 5)),
                                  qVar"state"),
                               Apply
           ...
           Mop(Snd,
               Apply
                 (Call
                  ...
                  qVar"state")))])))
;
val dfn'LoadStoreRegisterFloatingPoint_def = Def
  ("dfn'LoadStoreRegisterFloatingPoint",
   TP[Var("size",FTy 2),Var("opc",FTy 2),Var("imm12",FTy 12),
      ...
      Let(Var("address",F64),
          Bop(Add,
              ITE(EQ(Var("n",FTy 5),LW(31,5)),
                  Apply(Const("SP",ATy(qTy,F64)),qVar"state"),
                    ...
                    Apply
                      (Call
                         ("write'Mem",ATy(qTy,qTy),
                          TP[Apply
                               (Call("D",ATy(qTy,F64),Var("t",FTy 5)),
                                qVar"state"),Var("address",F64),LN 8,
                        ...
                        Apply
                          (Call
                             ("Mem",ATy(qTy,PTy(F64,qTy)),
                              TP[Var("address",F64),LN 8,
                                 LC("AccType_NORMAL",CTy"AccType")]),
                           qVar"state"),
                        Apply
                          (Call
                             ("write'D",ATy(qTy,qTy),
                              TP[Var("v",F64),Var("t",FTy 5)]),qVar"s")))])),
              (AVar(FTy 2),
               Mop(Snd,
                   Apply
                     (Call
                      ...
                      qVar"state")))]))))
;
val dfn'FloatingPointMov_def = Def
  ("dfn'FloatingPointMov",
   TP[Var("sf",F1),Var("ftype",FTy 2),Var("opcode0",F1),Var("n",FTy 5),
      Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(TP[Var("sf",F1),Var("ftype",FTy 2)],
         [(TP[LW(1,1),LW(1,2)],
           CS(Var("opcode0",F1),
              [(LW(0,1),
                Apply
           ...
           Mop(Snd,
               Apply
                 (Call
                  ...
                  qVar"state")))])))
;
val dfn'FloatingPointMovImm_def = Def
  ("dfn'FloatingPointMovImm",
   TP[Var("ftype",FTy 2),Var("imm8",F8),Var("d",FTy 5)],
   Close
     (qVar"state",
      CS(Var("ftype",FTy 2),
         [(LW(1,2),
           Apply
             (Call
                ("write'D",ATy(qTy,qTy),
                 TP[Call("FPExpandImm8",F64,Var("imm8",F8)),Var("d",FTy 5)]),
              qVar"state")),
          (AVar(FTy 2),
           Mop(Snd,
               Apply
         ...
         [(Const("Reserved",CTy"instruction"),
          ...
          (Call
             ("Address",CTy"instruction",
              Var("v89",PTy(bTy,PTy(F64,FTy 5)))),
           Apply
             (Call
                ("dfn'Address",ATy(qTy,qTy),
                 Var("v89",PTy(bTy,PTy(F64,FTy 5)))),qVar"state")),
          (Call("ClearExclusive",CTy"instruction",Var("v90",F4)),
           Apply
             (Call("dfn'ClearExclusive",ATy(qTy,qTy),Var("v90",F4)),
              qVar"state")),
          (Call("Hint",CTy"instruction",Var("v91",CTy"SystemHintOp")),
           Apply
             (Call("dfn'Hint",ATy(qTy,qTy),Var("v91",CTy"SystemHintOp")),
              qVar"state")),
          (Call
             ("MemoryBarrier",CTy"instruction",
              Var("v92",PTy(CTy"MemBarrierOp",F4))),
           Apply
             (Call
                ("dfn'MemoryBarrier",ATy(qTy,qTy),
                 Var("v92",PTy(CTy"MemBarrierOp",F4))),qVar"state")),
              ...
              [(Call
               ...
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state")),
               (Call
                  ("FloatingPointAddSub",CTy"Data",
                   Var("v37",
                       PTy(F1,PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
                     ("dfn'FloatingPointAddSub",ATy(qTy,qTy),
                      Var("v37",
                          PTy(F1,PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                   qVar"state")),
               (Call
                  ("FloatingPointCompare",CTy"Data",
                   Var("v38",PTy(FTy 2,PTy(FTy 2,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'FloatingPointCompare",ATy(qTy,qTy),
                      Var("v38",PTy(FTy 2,PTy(FTy 2,PTy(FTy 5,FTy 5))))),
                   qVar"state")),
               (Call
                  ("FloatingPointDiv",CTy"Data",
                   Var("v39",PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'FloatingPointDiv",ATy(qTy,qTy),
                      Var("v39",PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                   qVar"state")),
               (Call
                  ("FloatingPointMov",CTy"Data",
                   Var("v40",PTy(F1,PTy(FTy 2,PTy(F1,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
                     ("dfn'FloatingPointMov",ATy(qTy,qTy),
                      Var("v40",
                          PTy(F1,PTy(FTy 2,PTy(F1,PTy(FTy 5,FTy 5)))))),
                   qVar"state")),
               (Call
                  ("FloatingPointMovImm",CTy"Data",
                   Var("v41",PTy(FTy 2,PTy(F8,FTy 5)))),
                Apply
                  (Call
                     ("dfn'FloatingPointMovImm",ATy(qTy,qTy),
                      Var("v41",PTy(FTy 2,PTy(F8,FTy 5)))),qVar"state")),
               (Call
                  ("FloatingPointMul",CTy"Data",
                   Var("v42",PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'FloatingPointMul",ATy(qTy,qTy),
                      Var("v42",PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                   qVar"state")),
               (Call
                  ("FloatingPointMulAdd",CTy"Data",
                   Var("v43",
                       PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
                     ("dfn'FloatingPointMulAdd",ATy(qTy,qTy),
                      Var("v43",
                          PTy(FTy 2,PTy(FTy 5,PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                   qVar"state")),
               (Call
               ...
               (Call
                  ("MultiplyHigh",CTy"Data",
                   Var("v53",PTy(bTy,PTy(FTy 5,PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@32",CTy"Data",
                   Var("v54",PTy(F32,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
               ...
               (Call
                  ("Reverse@64",CTy"Data",
                   Var("v55",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                Apply
                  (Call
                     ("dfn'Reverse",ATy(qTy,qTy),
                      Var("v55",PTy(F64,PTy(CTy"RevOp",PTy(FTy 5,FTy 5))))),
                      ...
                      Var("v57",
                          PTy(F64,
                              PTy(CTy"ShiftType",
                                  PTy(FTy 5,PTy(FTy 5,FTy 5)))))),
                   qVar"state"))])),
          (Call("Debug",CTy"instruction",Var("v58",CTy"Debug")),
           CS(Var("v58",CTy"Debug"),
              [(Const("DebugRestore",CTy"Debug"),
                Apply(Const("dfn'DebugRestore",ATy(qTy,qTy)),qVar"state")),
               (Call("Breakpoint",CTy"Debug",Var("v59",F16)),
                Apply
                  (Call("dfn'Breakpoint",ATy(qTy,qTy),Var("v59",F16)),
                   qVar"state")),
               (Call("DebugSwitch",CTy"Debug",Var("v60",FTy 2)),
                Apply
                  (Call("dfn'DebugSwitch",ATy(qTy,qTy),Var("v60",FTy 2)),
                   qVar"state")),
               (Call("Halt",CTy"Debug",Var("v61",F16)),
                Apply
                  (Call("dfn'Halt",ATy(qTy,qTy),Var("v61",F16)),
                   qVar"state"))])),
          (Call("LoadStore",CTy"instruction",Var("v62",CTy"LoadStore")),
           CS(Var("v62",CTy"LoadStore"),
              [(Call
               ...
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state")),
               (Call
                  ("LoadStoreRegisterFloatingPoint",CTy"LoadStore",
                   Var("v81",
                       PTy(FTy 2,PTy(FTy 2,PTy(FTy 12,PTy(FTy 5,FTy 5)))))),
                Apply
                  (Call
                     ("dfn'LoadStoreRegisterFloatingPoint",ATy(qTy,qTy),
                      Var("v81",
                          PTy(FTy 2,
                              PTy(FTy 2,PTy(FTy 12,PTy(FTy 5,FTy 5)))))),
                   qVar"state"))])),
          (Call("System",CTy"instruction",Var("v82",CTy"System")),
           CS(Var("v82",CTy"System"),
              [(Const("ExceptionReturn",CTy"System"),
                Apply
                  (Const("dfn'ExceptionReturn",ATy(qTy,qTy)),qVar"state")),
               (Call("HypervisorCall",CTy"System",Var("v83",F16)),
                Apply
                  (Call("dfn'HypervisorCall",ATy(qTy,qTy),Var("v83",F16)),
                   qVar"state")),
               (Call
                  ("MoveImmediateProcState",CTy"System",
                   Var("v84",PTy(CTy"PSTATEField",F4))),
                Apply
                  (Call
                     ("dfn'MoveImmediateProcState",ATy(qTy,qTy),
                      Var("v84",PTy(CTy"PSTATEField",F4))),qVar"state")),
               (Call
                ...
                Apply
                  (Call
                   ...
                   qVar"state")),
               (Call("SecureMonitorCall",CTy"System",Var("v86",F16)),
                Apply
                  (Call
                     ("dfn'SecureMonitorCall",ATy(qTy,qTy),Var("v86",F16)),
                   qVar"state")),
               (Call("SupervisorCall",CTy"System",Var("v87",F16)),
                Apply
                  (Call("dfn'SupervisorCall",ATy(qTy,qTy),Var("v87",F16)),
                   qVar"state")),
               (Call
            ...
            (Bop(And,Mop(Not,bVar"b'31"),
             ...
             Call
               ("Data",CTy"instruction",
                Call
                  ("FloatingPointMul",CTy"Data",
                   TP[Mop(Cast(FTy 2),LL[bVar"b'23",bVar"b'22"]),
                      Mop(Cast(FTy 5),
                          LL[bVar"b'20",bVar"b'19",bVar"b'18",bVar"b'17",
                             bVar"b'16"]),
                      Mop(Cast(FTy 5),
             ...
             Call
               ("Data",CTy"instruction",
                Call
                  ("FloatingPointCompare",CTy"Data",
                   TP[Mop(Cast(FTy 2),LL[bVar"b'23",bVar"b'22"]),
                      Mop(Cast(FTy 2),LL[bVar"b'4",bVar"b'3"]),
                      Mop(Cast(FTy 5),
                          LL[bVar"b'20",bVar"b'19",bVar"b'18",bVar"b'17",
                             bVar"b'16"]),
                      Mop(Cast(FTy 5),
  ...
  ("e_data",Var("i",CTy"Data"),
   CS(Var("i",CTy"Data"),
      [(Call
       ...
       (Call
          ("FloatingPointAddSub",CTy"Data",
           TP[Var("op",F1),Var("ftype",FTy 2),Var("rm",FTy 5),
              Var("rn",FTy 5),Var("rd",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(30,8),Var("ftype",FTy 2),LW(1,1),Var("rm",FTy 5),LW(1,3),
              Var("op",F1),LW(2,2),Var("rn",FTy 5),Var("rd",FTy 5)])),
       (Call
          ("FloatingPointMul",CTy"Data",
           TP[Var("ftype",FTy 2),Var("rm",FTy 5),Var("rn",FTy 5),
              Var("rd",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(30,8),Var("ftype",FTy 2),LW(1,1),Var("rm",FTy 5),LW(2,6),
              Var("rn",FTy 5),Var("rd",FTy 5)])),
       (Call
          ("FloatingPointMulAdd",CTy"Data",
           TP[Var("ftype",FTy 2),Var("rm",FTy 5),Var("ra",FTy 5),
              Var("rn",FTy 5),Var("rd",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(31,8),Var("ftype",FTy 2),LW(0,1),Var("rm",FTy 5),LW(0,1),
              Var("ra",FTy 5),Var("rn",FTy 5),Var("rd",FTy 5)])),
       (Call
          ("FloatingPointDiv",CTy"Data",
           TP[Var("ftype",FTy 2),Var("rm",FTy 5),Var("rn",FTy 5),
        ...
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(30,8),Var("ftype",FTy 2),LW(1,1),Var("rm",FTy 5),LW(6,6),
              Var("rn",FTy 5),Var("rd",FTy 5)])),
       (Call
          ("FloatingPointCompare",CTy"Data",
           TP[Var("ftype",FTy 2),Var("opc",FTy 2),Var("rm",FTy 5),
              Var("rn",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(30,8),Var("ftype",FTy 2),LW(1,1),Var("rm",FTy 5),LW(8,6),
              Var("rn",FTy 5),Var("opc",FTy 2),LW(0,3)])),
       (Call
          ("FloatingPointMov",CTy"Data",
           TP[Var("sf",F1),Var("ftype",FTy 2),Var("opcode0",F1),
              Var("rn",FTy 5),Var("rd",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[Var("sf",F1),LW(30,7),Var("ftype",FTy 2),LW(19,5),
              Var("opcode0",F1),LW(0,6),Var("rn",FTy 5),Var("rd",FTy 5)])),
       (Call
          ("FloatingPointMovImm",CTy"Data",
           TP[Var("ftype",FTy 2),Var("imm8",F8),Var("rd",FTy 5)]),
        Call
          ("ARM8",CTy"MachineCode",
           CC[LW(30,8),Var("ftype",FTy 2),LW(1,1),Var("imm8",F8),LW(4,3),
              LW(0,5),Var("rd",FTy 5)]))]))
;
val e_debug_def = Def
   ...
   CS(Var("i",CTy"LoadStore"),
      [(Call
       ...
       (Call
        ...
        Call
          ("ARM8",CTy"MachineCode",
           CC[Var("size",FTy 2),LW(61,6),Var("opc",FTy 2),
              Var("imm12",FTy 12),Var("rn",FTy 5),Var("rt",FTy 5)]))]))
;
val Encode_def = Def
